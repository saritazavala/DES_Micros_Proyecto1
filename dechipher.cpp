...
void writeFile(string text) {
	int counter = 1;
	ofstream write("descifrado.txt", ios::app);
	if (!write) {
...
string initper(string cift)
{
	...
	primera = primera + g1[57] + g1[49] + g1[41] + g1[33] + g1[25] + g1[17] + g1[9] + g1[1] + g1[59] + g1[51] + g1[43] + g1[35] + g1[27] + g1[19] + g1[11] + g1[3];
	primera = primera + g1[61] + g1[53] + g1[45] + g1[37] + g1[29] + g1[21] + g1[13] + g1[5] + g1[63] + g1[55] + g1[47] + g1[39] + g1[31] + g1[23] + g1[15] + g1[7];
	primera = primera + g1[56] + g1[48] + g1[40] + g1[32] + g1[24] + g1[16] + g1[8] + g1[0] + g1[58] + g1[50] + g1[42] + g1[34] + g1[26] + g1[18] + g1[10] + g1[2];
	primera = primera + g1[60] + g1[52] + g1[44] + g1[36] + g1[28] + g1[20] + g1[12] + g1[4] + g1[62] + g1[54] + g1[46] + g1[38] + g1[30] + g1[22] + g1[14] + g1[6];
	return primera;
}
...
string feistelRounds(string bit64Word, vector<string> keys){
    ...
    for (int j = 0; j < 8; ++j) {
        ...
        string key = keys[7-j];
        tempright32Bits = DES(tempright32Bits, keys[7-j]);
